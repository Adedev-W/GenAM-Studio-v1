            ...
            <CardContent className="grid gap-8 pt-4">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="agent-name" placeholder="e.g., SupportBot-v2" defaultValue="Data-Processor-Alpha"/>
                </div>
                <div className="space-y-2">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <Textarea
                    ...
                    defaultValue="This agent is designed to process incoming data streams, analyze for anomalies, and categorize information based on predefined rules."
                  />
                </div>
              </div>
